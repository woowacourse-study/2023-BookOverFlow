...
- 엔티티는 HTTP 메시지의 일부를 말하는데 메시지는 엔티티를 감싸 만든다. 즉 메시지는 컨테이너로 엔티티 화물로 비유할 수 있다. 아래 그림은 HTTP 메시지에서 엔티티 영역을 보여준다.

<img width="700" src="https://github.com/woowacourse-teams/2023-naaga/assets/84285337/4825ed70-2978-448d-acfe-37d06d0e9571">
...
- MIME의 확장 사양에 있는 멀티파트라고 하는 여러 다른 종류의 데이터를 수용하는 방법을 사용하는 것이다.
